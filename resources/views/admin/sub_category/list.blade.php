        ...
        <div class="card">
            ...
            <div class="card-header">
                <div class="card-title">
                    <button type="button" onclick="window.location.href='{{route('sub-category.index')}}'" class="btn btn-primary">Reset</button>
                </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{route('subcategory.del',$item->id)}}" class="text-danger w-4 h-4 mr-1">
